...
The dashboard plugin for Wolf CMS was originally created by "tuupola":http://github.com/tuupola. I took over maintainership for the plugin on his request since he no longer has time to work on it.
